...
float PerlinNoise::octave_noise_2d( const float octaves, const float persistence, const float scale, const float x, const float y ) {
    float total = 0;
...
// For each octave, a higher frequency/lower amplitude function will be added to the original.
// The higher the persistence [0-1], the more of each succeeding octave will be added.
float PerlinNoise::octave_noise_3d( const float octaves, const float persistence, const float scale, const float x, const float y, const float z ) {
    float total = 0;
    float frequency = scale;
    float amplitude = 1;
...
// For each octave, a higher frequency/lower amplitude function will be added to the original.
// The higher the persistence [0-1], the more of each succeeding octave will be added.
float PerlinNoise::octave_noise_4d( const float octaves, const float persistence, const float scale, const float x, const float y, const float z, const float w ) {
    float total = 0;
    float frequency = scale;
    float amplitude = 1;
...
float PerlinNoise::scaled_octave_noise_2d( const float octaves, const float persistence, const float scale, const float loBound, const float hiBound, const float x, const float y ) {
...
//
// Returned value will be between loBound and hiBound.
float PerlinNoise::scaled_octave_noise_3d( const float octaves, const float persistence, const float scale, const float loBound, const float hiBound, const float x, const float y, const float z ) {
...
//
// Returned value will be between loBound and hiBound.
float PerlinNoise::scaled_octave_noise_4d( const float octaves, const float persistence, const float scale, const float loBound, const float hiBound, const float x, const float y, const float z, const float w ) {
...
//
// Returned value will be between loBound and hiBound.
float PerlinNoise::scaled_raw_noise_2d( const float loBound, const float hiBound, const float x, const float y ) {
...
//
// Returned value will be between loBound and hiBound.
float PerlinNoise::scaled_raw_noise_3d( const float loBound, const float hiBound, const float x, const float y, const float z ) {
...
//
// Returned value will be between loBound and hiBound.
float PerlinNoise::scaled_raw_noise_4d( const float loBound, const float hiBound, const float x, const float y, const float z, const float w ) {
...
float PerlinNoise::raw_noise_2d( const float x, const float y ) {
...
float PerlinNoise::raw_noise_3d( const float x, const float y, const float z ) {
...
float PerlinNoise::raw_noise_4d( const float x, const float y, const float z, const float w ) {
...
int PerlinNoise::fastfloor( const float x ) { return x > 0 ? (int) x : (int) x - 1; }

float PerlinNoise::dot( const int* g, const float x, const float y ) { return g[0]*x + g[1]*y; }
float PerlinNoise::dot( const int* g, const float x, const float y, const float z ) { return g[0]*x + g[1]*y + g[2]*z; }
float PerlinNoise::dot( const int* g, const float x, const float y, const float z, const float w ) { return g[0]*x + g[1]*y + g[2]*z + g[3]*w; }


// 2D Marble Noise: x-axis.
float PerlinNoise::marble_noise_2d( const float octaves, const float persistence, const float scale, const float x, const float y ) {
    return cosf( x * scale + octave_noise_2d(octaves, persistence, scale / 3, x, y) );
}


// 3D Marble Noise: x-axis.
float PerlinNoise::marble_noise_3d( const float octaves, const float persistence, const float scale, const float x, const float y, const float z ) {
    return cosf( x * scale + octave_noise_3d(octaves, persistence, scale / 3, x, y, z) );
}


// 4D Marble Noise: x-axis.
float PerlinNoise::marble_noise_4d( const float octaves, const float persistence, const float scale, const float x, const float y, const float z, const float w ) {
...
//static void PerlinNoise::init(void);
...
inline void PerlinNoise::init(void)
{
	int i, j, k;
